...
const categories = [
  { name: "Vegetables", image: "https://placehold.co/400x300.png", hint: "fresh vegetables" },
  { name: "Spices & Masalas", image: "https://placehold.co/400x300.png", hint: "assorted spices" },
  { name: "Grains & Flour", image: "https://placehold.co/400x300.png", hint: "sacks of grain" },
  { name: "Oils & Ghee", image: "https://placehold.co/400x300.png", hint: "cooking oil bottles" },
  { name: "Dairy & Paneer", image: "https://placehold.co/400x300.png", hint: "cheese blocks" },
  { name: "Snacks & Pellets", image: "https://placehold.co/400x300.png", hint: "puri pellets" },
  { name: "Chutneys & Sauces", image: "https://placehold.co/400x300.png", hint: "chutney bowls" },
  { name: "Disposables", image: "https://placehold.co/400x300.png", hint: "paper plates cups" },
];
